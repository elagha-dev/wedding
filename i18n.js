...
window.I18N = {
  ...
  en: {
    ...
    guestsLabel        : "💌 Guests",
    guestsHint         : "Everyone's in! Tap a name to remove someone.",
  ...
  de: {
    ...
    guestsLabel        : "💌 Gäste",
    guestsHint         : "Alle sind dabei! Tippe einen Namen, um jemanden zu entfernen.",
  ...
  ru: {
    ...
    guestsLabel        : "💌 Гости",
    guestsHint         : "Все идут! Нажмите на имя, чтобы убрать кого-то.",
