...
window.I18N = {
  ...
  en: {
    ...
    bringShareAgendaBtn : "🧁 Sign up to bring something",
    ...
    guestsLabel        : "💌 Guests",
    guestsHint         : "Let us know who's able to join.",
    guestSplitHint     : "Looks like you two aren't doing the exact same thing — go ahead and submit this RSVP, then use \"Submit another RSVP\" on the confirmation screen to log the other guest's own answers separately.",
    yesBtnShort        : "Yes",
    noBtnShort         : "No",
    ...
    declineNoteSendBtn : "Send note",
    declineNoteSending : "Sending…",
    declineNoteSent    : "Thank you — your note has been sent. ♡",
    declineNoteSendErr : "Something went wrong. Please try again.",
    declineNoteEmptyErr: "Write a short note first, or just close this.",
    sendRsvpBtn    : "Confirm attendance ✓",
    sendRsvpBtnDecline : "We sadly can't make it",
    selectAttendanceErr: "Please let us know if you'll be attending the ceremony.",
    selectPartyAttendErr: "Please let us know if you'll be attending the evening reception.",
    ...
    gateSalutationSingle : "You are invited",
    ...
    gateBodySingle   : "<div class='gate-timeline'><span class='gate-tl-item'><strong>13:30</strong> Arrival</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>14:00</strong> Ceremony</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>15:00</strong> Get Together (Bring &amp; Share)</span></div><br>After the ceremony, we'll gather outside the church building for snacks and drinks — and some time together. You're very welcome to bring something to share. ♡",
    ...
    gateBodyPartySingle : "<div class='gate-timeline'><span class='gate-tl-item'><strong>13:30</strong> Arrival</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>14:00</strong> Ceremony</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>15:00</strong> Get Together (Bring &amp; Share)</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>17:00</strong> Evening Reception</span></div><br>After the ceremony, we'll gather outside the church building for snacks and drinks — and some time together. You're very welcome to bring something to share. In the evening, we'll continue the celebration with an evening reception starting at 17:00. ♡",
    gateNote         : "Want to bring something? You can sign up when you RSVP. ♡",
    gateNoteSingle   : "Want to bring something? You can sign up when you RSVP. ♡",
  ...
  de: {
    ...
    bringShareAgendaBtn : "🧁 Eintragen, was ihr mitbringt",
    ...
    guestsLabel        : "💌 Gäste",
    guestsHint         : "Bitte für jeden Gast angeben, ob er teilnehmen kann.",
    guestSplitHint     : "Sieht so aus, als hättet ihr unterschiedliche Pläne — schickt diese RSVP ab und nutzt danach auf dem Bestätigungsbildschirm \"Weitere RSVP abschicken\", um die Antwort der anderen Person separat einzutragen.",
    yesBtnShort        : "Ja",
    noBtnShort         : "Nein",
    payloadAttendance  : "Teilnahme:",
    payloadGuests      : "Gäste:",
    payloadCeremony    : "Trauung:",
    payloadEvening     : "Feier:",
    tlGetTogether      : "Arrival",
    ...
    declineNoteSendBtn : "Nachricht senden",
    declineNoteSending : "Wird gesendet…",
    declineNoteSent    : "Danke — eure Nachricht wurde gesendet. ♡",
    declineNoteSendErr : "Etwas ist schiefgelaufen. Bitte versucht es erneut.",
    declineNoteEmptyErr: "Schreibt zuerst eine kurze Nachricht oder schließt einfach dieses Fenster.",
    sendRsvpBtn    : "Teilnahme bestätigen ✓",
    sendRsvpBtnDecline : "Leider können wir nicht kommen",
    selectAttendanceErr: "Bitte gebt an, ob ihr zur Trauung kommt.",
    selectPartyAttendErr: "Bitte gebt an, ob ihr zur Abendfeier kommt.",
    ...
    gateSalutationSingle : "Du bist herzlich eingeladen,",
    ...
    gateBodySingle   : "<div class='gate-timeline'><span class='gate-tl-item'><strong>13:30</strong> Arrival</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>14:00</strong> Ceremony</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>15:00</strong> Get Together (Bring &amp; Share)</span></div><br>Nach der Zeremonie treffen wir uns draußen vor dem Kirchengebäude bei Snacks und Getränken — und verbringen Zeit miteinander. Wer möchte, bringt gerne etwas zum Teilen mit. ♡",
    ...
    gateNoteSingle   : "Möchtest du etwas mitbringen? Du kannst dich bei deiner Rückmeldung eintragen. ♡",
  ...
  ru: {
    ...
    bringShareAgendaBtn : "🧁 Записаться и указать, что принесёте",
    ...
    guestsLabel        : "💌 Гости",
    guestsHint         : "Укажите, пожалуйста, для каждого гостя, сможет ли он прийти.",
    guestSplitHint     : "Похоже, у вас разные планы — отправьте эту анкету, а затем на экране подтверждения нажмите «Отправить ещё одну анкету», чтобы указать ответ второго гостя отдельно.",
    yesBtnShort        : "Да",
    noBtnShort         : "Нет",
    payloadAttendance  : "Участие:",
    payloadGuests      : "гости:",
    payloadCeremony    : "венчание:",
    payloadEvening     : "приём:",
    tlGetTogether      : "Arrival",
    ...
    declineNoteSendBtn : "Отправить сообщение",
    declineNoteSending : "Отправка…",
    declineNoteSent    : "Спасибо — ваше сообщение отправлено. ♡",
    declineNoteSendErr : "Что-то пошло не так. Попробуйте ещё раз.",
    declineNoteEmptyErr: "Сначала напишите короткое сообщение, либо просто закройте это окно.",
    sendRsvpBtn    : "Подтвердить участие ✓",
    sendRsvpBtnDecline : "К сожалению, мы не сможем прийти",
    selectAttendanceErr: "Пожалуйста, укажите, сможете ли вы прийти на венчание.",
    selectPartyAttendErr: "Пожалуйста, укажите, сможете ли вы прийти на вечерний приём.",
    ...
    comingSoon         : "Скоро",
    bsTileTitle        : "Bring & Share",
    bsTileDesc         : "Каждый приносит что-нибудь поесть — торт, пирог, закуски. После церемонии едим и делимся всем вместе.",
    ...
    gateSalutationSingle : "Вы приглашены,",
    ...
    gateBodySingle   : "<div class='gate-timeline'><span class='gate-tl-item'><strong>13:30</strong> Arrival</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>14:00</strong> Ceremony</span><span class='gate-tl-sep'>→</span><span class='gate-tl-item'><strong>15:00</strong> Get Together (Bring &amp; Share)</span></div><br>После церемонии мы будем рады, если все останутся на улице у церкви — каждый ставит что-нибудь на стол, и мы вместе перекусим и выпьем бокал шампанского. Торты, пироги, выпечка, закуски — всё приветствуется.",
    ...
    gateNoteSingle   : "Хотите что-то принести? Можно записаться при ответе на приглашение. ♡",
    ...
    bsStep1Hint     : "Напишите, что планируете принести — так нам будет проще сделать хорошую подборку. Готовить на 140 человек не нужно! 🙂",
    ...
    bsDoneKicker    : "Вы лучшие 🧁",
    bsDoneTitle     : "Вы в списке — спасибо!",
    bsDoneHint      : "Мы записали, что вы принесёте. С нетерпением ждём, когда после церемонии сможем вместе перекусить и поднять бокал. ♡",
    bsArrivalText   : "Пожалуйста, приходите до <strong>13:30</strong> и положите ваш вклад на стол <strong>Bring &amp; Share</strong> у входа в церковь — он будет хорошо обозначен. Потом оставайтесь — перекусим и выпьем бокал шампанского вместе!",
